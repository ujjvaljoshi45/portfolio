...
export const DATA = {
  ...
  description:
    "Software Engineer. I love building apps. Very active on LinkedIn.",
  summary:
    "Adaptable and enthusiastic professional with a proven ability to excel in dynamic environments. A fast learner and collaborative team player who embraces new opportunities. Ready to contribute my skills and positive energy to drive success in any setting.",
  avatarUrl: "/me.png",
  skills: [
    "Flutter",
    "Dart",
  ...
  contact: {
    ...
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/ujjvaljoshi45",
        icon: Icons.github,
        navbar: true,
      },
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/ujjvaljoshi45/",
        icon: Icons.linkedin,
      ...
      X: {
        name: "X",
        url: "https://twitter.com/joshi_ujjval17",
        icon: Icons.x,
      ...
      Instagram: {
        name: "Instagram",
        url: "https://www.instagram.com/ujjval.17/",
        icon: Icons.instagram,
        navbar: true,
      },
      email: {
        name: "Send Email",
        url: "mailto:ujjvaljoshi45@gmail.com",
        icon: Icons.email,
  ...
  work: [
    ...
    {
      company: "Ignetion Nest Labs",
      badges: [],
      href: "https://ignetionnestlabs.com",
  ...
  projects: [
    {
      title: "AI Buddy",
      href: "https://play.google.com/store/apps/details?id=com.nt.ai&pcampaignid=web_share",
      // dates: "Jan 2024 - Feb 2024",
      active: true,
      description:
        "Integrated Dall-E's image gen to a flutter app along with Open AI's Assistants API and Gemini API.",
      technologies: [
        "Flutter",
        "Dart",
        "Open AI Assistant's API",
        "Gemini API",
        "Firebase Auth",
        "Firebase Firestore",
        "Firebase Storage",
    ...
    },
    {
      ...
      active: true,
      description:
        "A platform for fitness fans to flunk there freaking achievements online",
      technologies: [
        "Flutter",
        "Dart",
        "Bloc",
